...
CFLAGS = -g -I/usr/include/jsoncpp -I/opt/homebrew/include -Wno-deprecated
...
LDFLAGS_SV = -L/opt/homebrew/lib -ljsoncpp -lmicrohttpd -ljsonrpccpp-common -ljsonrpccpp-server
LDFLAGS_CL = -L/opt/homebrew/lib -ljsoncpp -lcurl -ljsonrpccpp-common -ljsonrpccpp-client
