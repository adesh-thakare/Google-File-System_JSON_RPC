 ...
 std::string arg_commitorabort)
{
  ...
  try {
    ...
    std::cout <<" Line " << __LINE__ << " Inside the Shadow Replica.CommitAbort" << std::endl;
    ...
    cout << " Result" << myv.toStyledString() << endl;
...
(std::string arg_name, std::string arg_fhandle, std::string arg_chunk_index, std::string arg_chunk)
{
  ...
  try {
    std::cout <<" Line " << __LINE__ << " Inside the Shadow Replica.PushChunk2Replica" << std::endl;

    // std::cout <<arg_name << "  "<< arg_fhandle<<" " << arg_chunk_index<<" "<< arg_chunk <<std::endl;
    ...
    //std::cout << "Line 62 myv"<< std::endl;
  // cout << "AAA" << myv.toStyledString() << endl;
  }
  catch (JsonRpcException &e) {


    std::cout << "Line " << __LINE__ << " Catch" << std::endl;
    cerr << e.what() << endl;
  }
  return myv;
}
...
()
{
  ...
  try {
    std::cout << "calling NFS dumpJ SHD" << std::endl;
