...
(std::string arg_name, std::string arg_fhandle, std::string arg_chunk_index)
{
  ...
  // std::cout << arg_name <<"  "<< arg_fhandle <<" "<< arg_chunk_index << std::endl;
  /*"http://127.0.0.1:8300"
  "http://127.0.0.1:8300"
  "http://127.0.0.1:8300"
  */
  std::cout <<" Line " << __LINE__ << " Inside the Directory.ObtainChunkURL" << std::endl;
...
/*
  result["primary"]      = "http://127.0.0.1:8300";
  result["secondary_A"]  = "http://127.0.0.1:8301";
  result["secondary_B"]  = "http://127.0.0.1:8302";
*/
  return result;
}
